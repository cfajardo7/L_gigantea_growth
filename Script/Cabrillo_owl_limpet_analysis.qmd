...
p_small_density_emm <- ggplot(df_small_density_emm, aes(x = season, y = density)) + 
  ...
  geom_jitter(data = small_density, aes(x = season, y = density_m2, color = plot_name), 
              alpha = 0.8, width = 0.1)+
  geom_point(size = 4) +
...
p_large_density_emm <- ggplot(df_large_density_emm, aes(x = season, y = density)) + 
  ...
  geom_jitter(data = large_density, aes(x = season, y = density_m2, color = plot_name), 
              alpha = 0.8, width = 0.1)+
  geom_point(size = 4) +
...
sst_wave_upwell_cnm <- (upw_box+labs(title = NULL)+theme(axis.title.x = element_blank()) | temp_box+labs(title = NULL)+theme(axis.title.x = element_blank()) | wave_box+labs(title = NULL)+theme(axis.title.x = element_blank())) +plot_annotation(tag_levels = "a")+plot_annotation(caption = "Date (2023-2024)",
    theme = theme(plot.caption = element_text(size = 15, face = "bold", hjust = 0.5)))
sst_wave_upwell_cnm
