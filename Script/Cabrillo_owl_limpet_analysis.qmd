...
upw_box <- per_field_season_upwelling %>%
    ggplot(aes(x = date, y = CUTI, fill = season))+
...
temp_box <- per_field_season_temp %>%
    ggplot(aes(x = time, y = sst, fill = season))+
    geom_boxplot(show.legend = FALSE)+
  scale_fill_manual(values = season_colors)+
    labs(x = "Date (2023-2024)",
...
#### Wave Data
 ...
 wave_box <- joined_wave_data %>%
    ggplot(aes(x = date, y = Thgt, fill = season))+
    geom_boxplot(show.legend = FALSE)+
  scale_fill_manual(values = season_colors)+
    labs(x = "Date (2023-2024)",
...
#| fig-height: 6
## Bring the figures together for pub quality
sst_wave_upwell_cnm <- (upw_box+labs(title = NULL)+theme(axis.title.x = element_blank()) | temp_box+labs(title = NULL)+theme(axis.title.x = element_blank()) | wave_box+labs(title = NULL)+theme(axis.title.x = element_blank())) +plot_annotation(tag_levels = "a")+plot_annotation(caption = "Date (2023-2024)",
