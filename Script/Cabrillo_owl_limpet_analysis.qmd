...
p_density_emm <- ggplot(df_density_emm, aes(x = season, y = density)) + 
  ...
  geom_jitter(data = limpet_density, aes(x = season, y = density_m2, color = plot_name), 
              alpha = 0.8, width = 0.1)+
  geom_point(size = 4) +
...
## Bring the figures together for pub quality
## Add in stars with brackes to show significance between seasons based on emmeans
small_large_SL <- (p_small_size+labs(title = NULL)|p_large_size_emm+labs(title = NULL))+plot_annotation(tag_levels = "a")
small_large_SL
