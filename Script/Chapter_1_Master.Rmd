...
#Use thi to look at Cabrillo Data Per Year 
CNM_ZThree_per_year_data <- CNM_ZThree__yearly_data%>%
  filter(survey_year=="1990") #change this to match the year you are looking for
...
dip_CNM_ZThree_per_year_data <- CNM_ZThree__yearly_data %>% 
  filter(survey_year %in% c("1990","1995","1996","2002","2006","2007","2016","2020","2021"))#change this to match the year you are looking for
