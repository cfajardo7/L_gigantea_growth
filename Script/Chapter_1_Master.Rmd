...
long_mobiles <- mobiles_master %>% 
  ...
  species %in% "L_hartwegii" ~ "grazer",
  species %in%  "L_dentiens" ~ "grazer",
  species %in%  "L_plena" ~ "grazer",
  species %in%  "L_keenae" ~ "grazer",
  species %in%  "L_limatula" ~ "grazer",
  species %in%  "L_scabra" ~ "grazer",
  species %in%  "Nuttallina_sp" ~ "grazer",
  species %in%  "Mopalia_sp" ~ "grazer",
  species %in%  "P_crassipes" ~ "herbivore",
  species %in%  "T_eiseni" ~ "grazer",
  species %in%  "T_funebralis" ~ "grazer",
  species %in%  "T_gallina" ~ "grazer",
  species %in%  "L_gigantea" ~ "grazer"))
