...
qqnorm(log_size_dist_all_seasons$sqr_sl)

#lmer
sl_lmer<-lmer(SL_mm~Season+(1|Plot_Name), data = size_dist_all_seasons)
check_model(sl_lmer)

#glm
sl_glm<-glm(SL_mm~Season, data = size_dist_all_seasons, 
...
#glmm
sl_glmer<-glmer(SL_mm~Season+(1|Plot_Name), data = size_dist_all_seasons, 
             family = Gamma(link="log"))
check_model(sl_glmer)
anova(sl_glm)
summary(sl_glm)

#Post hoc tests
emmeans(sl_glmer, list(pairwise~Season), adjust = "tukey")
...
#glm
abundance_all_seasons <-glm(n~Season, data = linear_abundance,family = poisson(link = "log"))
check_model(abundance_all_seasons)
anova(mod_abundance_all_seasons)
summary(mod_abundance_all_seasons)

#Post hoc test
emmeans(abundance_all_seasons, list(pairwise~Season), adjust = "tukey")
